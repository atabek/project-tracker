...
func routes() *httprouter.Router {
	...
	// Employee
	r.GET("/employee", hr.Handler(alice.
		New(acl.DisallowAnon).
		ThenFunc(controller.EmployeeReadGET)))
	r.GET("/employee/create", hr.Handler(alice.
		New(acl.DisallowAnon).
		ThenFunc(controller.EmployeeCreateGET)))
	...
	r.POST("/employee/update/:id", hr.Handler(alice.
		New(acl.DisallowAnon).
		ThenFunc(controller.EmployeeUpdatePOST)))
	r.GET("/employee/delete/:id", hr.Handler(alice.
		New(acl.DisallowAnon).
